...
class User_model extends CI_Model {
    ...
    function get_s($clause,$limit=null,$offset=null,$sort_by='nama', $sort_order='asc')
    {
    ...
    {
        $this->db->join('role','role.id_role='.$this->table_name.'.role_id');
        $query = $this->db->get_where($this->table_name,array('id_user'=>$id));
        return $query->row_array();
    }
    ...
    {
        if(!is_array($clause))$clause=array('id_user'=>$clause);
